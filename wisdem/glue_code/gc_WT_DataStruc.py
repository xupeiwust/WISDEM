...
class Drivetrain(om.Group):
    ...
    def setup(self):
        ...
        if self.options["flags"]["drivetrain"]:
            ...
            ivc.add_output("platform_mass_user", val=0.0, units="kg", desc="Override regular regression-based calculation of platform mass with this value")
            ivc.add_output("cover_mass_user", val=0.0, units="kg", desc="Override regular regression-based calculation of cover mass with this value")
